...
public class DefenderDroneAgent : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(dirIT);
        sensor.AddObservation(dIT);
        sensor.AddObservation(dirIB);
        sensor.AddObservation(dIB);
        sensor.AddObservation(vSelfLocal);
        sensor.AddObservation(vRelLocal);
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        float face = Vector3.Dot(transform.forward, delta.normalized); AddReward(face * facingCoeff);
